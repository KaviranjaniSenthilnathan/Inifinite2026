...
namespace CodeChallenges4
{
    ...
    public class DistanceTest
    {
        ...
        {
            Distance a = new Distance { Kilometer = km1 };
            Distance b = new Distance { Kilometer = km2 };

            Distance result = Distance.Add(a, b);

            Assert.AreEqual(expected, result.Kilometer);
        }
    }
}